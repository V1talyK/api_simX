...
grd, gdm_prop, prp, x, nt = make_gdm(kp_init = 0.5, he_init = 5, nt_init = 3600)
...
qw[[1,3,7,9],:] .= (-abs.(qw[[1,3,7,9],:]).-10)*0;
qw[[2,4,5,6,8],:] .= abs.(qw[[2,4,5,6,8],:].+10)*0;
qw[5,:] .= 120
qw .= mean(qw,dims=2)
